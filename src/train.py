...
def train_and_evaluate(model_name):
    ...
    for epoch in range(CONFIG['num_epochs']):
        ...
        if val_auc > best_val_auc:
            ...
            torch.save({
                ...
                'val_auc': val_auc,
            }, f'../outputs/models/best_{model_name}_model.pt')
    ...
    np.save(f'../outputs/{model_name}_predictions.npy', test_preds)
    np.save(f'../outputs/{model_name}_labels.npy', test_labels)
