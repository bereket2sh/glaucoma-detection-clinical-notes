...
def evaluate_model_by_race(model_name):
    ...
    with open(f'{model_name}_fairness_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print(f"\n[4] Fairness results saved to {model_name}_fairness_results.json")
...
def create_fairness_visualizations(all_results):
    ...
    print("  ✓ Fairness visualization saved to 'fairness_comparison.png'")
    ...
    plt.tight_layout()
    plt.savefig('roc_curves_by_race.png', dpi=300, bbox_inches='tight')
    print("  ✓ ROC curves saved to 'roc_curves_by_race.png'")
